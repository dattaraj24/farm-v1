...
const FarmCard = (props) => {
  ...
  const { web3Var, userAccount, ethSigner, web3My } = access;
  ...
  const allowanceHandler = async (_lpContractAddress) => {
    ...
    const allowanceRes = await lpContract.allowance(
      props.userAccount,
  ...
  const fetchMaxBal = async () => {
    if (userAccount) {
      ...
      const masterChefContract = new ethers.Contract( 
        props.lpAddresses[56],
        LpAbi,
        web3Var
      );

      const BalanceRes = await masterChefContract.balanceOf(userAccount);
          ...
          <div className="row">
            <div className={`farm-top-${props.farmClass} text-center`}>
              ...
              <div className="d-flex justify-content-center">
                <img
                  className="farms-img"
                  src={require(`../../images/icon/${props.farmImg}.png`)}
                  alt="farm"
                />
                ...
                {!props.userAccount ? (
                  ...
                  <div className="row row-cols-2">
                    <div className="col-md-6">
                      ...
                      <div className="mt-2">{parseFloat(props.stakedBalance).toFixed(3)}</div>
                    </div>
                    <div className="col-md-6 mt-5">
                      <div className="row row-cols-2">
                        <div className="col-md-6">
                  ...
                  <div className="row d-flex">
                    ...
                    <div className="col">
                      ...
                      <div className="earn mt-4">
                        ${Math.round(props.totliquidity).toLocaleString()}
                      </div>
                    </div>
                    <div className="mt-4">
                      <a
