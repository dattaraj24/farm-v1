      ...
      <ul className="mainmenu">
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="axil-submenu">
            <li>
              <a href="http://v2exchanges.cytogenepathlab.in/#/swap" target="_blank">
                Exchange
              </a>
            </li>
            <li>
              <a href="http://v2exchanges.cytogenepathlab.in/#/pool" target="_blank">
                Liquidity
              </a>
            </li>
          </ul>
